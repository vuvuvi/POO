...
public class Courant {
    ...
    private exampleclass titulaire = new exampleclass("Resh", "Goo", LocalDate.of(1992, 07, 27));
    private String numero;
    private double solde;
    private double ligneDeCredit;

    public Courant(exampleclass titulaire, String numero) {
        this.titulaire = titulaire;
        this.numero = numero;
    }

    public Courant(exampleclass titulaire, String numero, double solde, double ligneDeCredit) {
        this.titulaire = titulaire;
        this.numero = numero;
        this.solde = solde;
    ...
    public exampleclass getTitulaire() {
        return this.titulaire;
    }

    public void setTitulaire(exampleclass titulaire) {
